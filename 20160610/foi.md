...
The [Open Science Initiative](http://openscience.fi) of the Finnish
Ministry of Education then organized the [data release]() as
summarized [elsewhere](). With this, Finland is becoming one of the
first countries where the subscription fees have been released at the
level of individual publishers. In fact, to our knowledge Finland is
the only country where the exact costs are available at this level for
all publishers and public institutions 2010-2015. In UK and US, for
instance, the information is available for some, but not all
publishers due to the complexities of gathering this
information. Similar FOI request process are ongoing in other
countries, including
