...
```{r foi-totalcosts, message=FALSE, echo=FALSE, fig.show="hold", out.width="400px", fig.width = 10, fig.height = 5}
...
p <- ggplot(dfs, aes(x = Type, y = Costs)) + geom_bar(stat = "identity") + ggtitle("Costs by agreement type") + coord_flip() + xlab("") + ylab("Total Costs (MEUR)")
print(p)
