...
dfs = rbind(dfs, c("Total", round(colSums(dfs[, as.character(c(2010:2015))]), 1)))
dfs$Total = round(rowSums(dfs[, as.character(2010:2015)], na.rm = TRUE), 1)
dfs[, as.character(c(2010:2015))] = round(dfs[, as.character(c(2010:2015))], 1)
