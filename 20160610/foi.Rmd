 ...
 * `r length(unique(df$Organization))` organizations ([costs by organization](table/cost_by_organization_year.csv))
 * `r length(unique(df$Publisher))` publishers ([costs by publisher](table/cost_by_publisher_year.csv))
