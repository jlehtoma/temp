...
p <- ggplot(dfs[1:20,], aes(x = Organization, y = Costs/1e6)) + geom_bar(stat = "identity") + ggtitle("Costs by organization") + coord_flip() + xlab("") + ylab("Total Costs (MEUR)")
print(p)
...
p <- ggplot(dfs[1:20,], aes(x = Publisher, y = Costs/1e6)) + geom_bar(stat = "identity") + ggtitle("Costs by publisher") + coord_flip() + xlab("") + ylab("Total Costs (MEUR)")
print(p)
...
p <- ggplot(dfs[1:20,], aes(x = Material, y = Costs/1e6)) + geom_bar(stat = "identity") + ggtitle("Costs by material") + coord_flip() + xlab("") + ylab("Total Costs (MEUR)")
print(p)
...
p <- ggplot(dfs[1:20,], aes(x = Type, y = Costs/1e6)) + geom_bar(stat = "identity") + ggtitle("Costs by publication type") + coord_flip() + xlab("") + ylab("Total Costs (MEUR)")
print(p)
